...
server.listen(8765,'0.0.0.0',()=>{
  ...
  for(const items of Object.values(os.networkInterfaces()))for(const i of items)if(i.family==='IPv4'&&!i.internal)console.log('Open on your phone: http://'+i.address+':8765');
});
