...
(() => {
 const G=window.Game;
 const option=(id: string,title: string,description: string,effect: MapleForest.Effect,cost: MapleForest.EventCost={}): MapleForest.EventOption=>({id,title,description,effect,cost});
 G.runEventCatalog=[
